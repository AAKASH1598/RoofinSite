...
function Footer() {
    return (
        <div className='footer-container'>
          ...
          <ul> 
            <li><Link to="/Roofing_Sheet">Roofing Sheet</Link></li> 
            <li><Link to="/Color_Roof">Colour Coated Roofing Sheet</Link></li> 
            <li><Link to="/MS_Roof">MS Roofing Sheet</Link></li>
             <li><Link to="/Aluminium_Roof">Aluminium Roofing Sheet</Link></li> 
             <li><Link to="/Paper_Sheet">Paper Sheet</Link></li> 
             <li><Link to="/Industrial_Roof">Industrial Roofing Sheet</Link></li> 
             <li><Link to="/Steel_Roof">Stainless Steel Roofing Sheet</Link></li> 
            </ul></div>
           <div class="footer_link"> 
          <ul>
